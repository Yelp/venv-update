...
release = venv_update.__version__
...
# of the sidebar.
html_logo = '_static/venv-update.svg'
...
latex_documents = [
    (master_doc, 'venv-update.tex', 'venv-update Documentation',
     'Buck Evan', 'manual'),
]
...
man_pages = [
    (master_doc, 'venv-update', 'venv-update Documentation',
     [author], 1)
]
...
def setup(app):
    app.connect(str('autodoc-process-docstring'), process_docstring)
